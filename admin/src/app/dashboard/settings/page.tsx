  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4">
        <div>
          <h1 className="text-xl md:text-2xl font-bold text-gray-900">Master Control</h1>
          <p className="text-sm md:text-base text-gray-500">Control global website content, contact info, and SEO details.</p>
        </div>
        <div className="flex w-full md:w-auto gap-2 md:gap-3">
          <button 
            onClick={fetchSettings}
            className="flex-1 md:flex-none flex items-center justify-center p-2.5 text-gray-500 hover:text-blue-600 hover:bg-blue-50 rounded-lg border border-gray-200 md:border-transparent transition-colors"
            title="Refresh"
          >
            <RefreshCw size={20} />
          </button>
          <button 
            ...
            className="flex-1 md:flex-none flex items-center justify-center gap-2 px-6 py-2.5 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-all disabled:opacity-50 shadow-lg shadow-blue-200 text-sm font-semibold"
          >
