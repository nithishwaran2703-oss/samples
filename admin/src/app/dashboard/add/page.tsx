      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
        <div className="px-8 py-6 border-b border-gray-200 bg-gray-50/50 flex justify-between items-center">
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">Provide the details to add this item to your collection.</p>
          </div>
        </div>

        <form onSubmit={handleSubmit} className="p-8 space-y-8">
          {success && (
            <div className="bg-green-50 border border-green-200 text-green-700 px-4 py-4 rounded-xl flex items-center gap-3 animate-in fade-in slide-in-from-top-2">
          ...
          <div className="space-y-2">
            ...
            <div className={`mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-dashed rounded-2xl transition-all ${imagePreview ? 'border-blue-400 bg-blue-50/30' : 'border-gray-300 hover:border-blue-400'}`}>
              <div className="space-y-1 text-center w-full">
                {imagePreview ? (
                  <div className="relative inline-block">
                    <img src={imagePreview} alt="Preview" className="mx-auto h-56 rounded-lg object-contain shadow-lg" />
                    <button 
                      type="button"
                  ...
                  <div className="py-10">
                    <div className="bg-gray-100 p-4 rounded-full inline-block mb-4 text-gray-400">
                      <Upload size={32} />
                    </div>
          ...
          <div className="flex items-center justify-end gap-4 pt-6 border-t border-gray-100">
            ...
            <button 
              ...
              className="flex items-center gap-2 px-10 py-4 bg-blue-600 text-white font-bold rounded-xl hover:bg-blue-700 focus:ring-4 focus:ring-blue-300 disabled:opacity-50 shadow-xl shadow-blue-200 transition-all transform active:scale-95"
            >
